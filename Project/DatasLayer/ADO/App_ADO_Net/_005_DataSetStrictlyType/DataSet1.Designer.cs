...
namespace App_ADO_Net._005_DataSetStrictlyType {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK__Address__PersonI__6FE99F9F;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK__Address__PersonI__6FE99F9F = this.Relations["FK__Address__PersonI__6FE99F9F"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK__Address__PersonI__6FE99F9F = new global::System.Data.DataRelation("FK__Address__PersonI__6FE99F9F", new global::System.Data.DataColumn[] {
                        this.tablePerson.IdColumn}, new global::System.Data.DataColumn[] {
                        this.tableAddress.PersonIdColumn}, false);
            this.Relations.Add(this.relationFK__Address__PersonI__6FE99F9F);
        }
        ...
        public partial class AddressDataTable : global::System.Data.TypedTableBase<AddressRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AddressRow AddAddressRow(PersonRow parentPersonRowByFK__Address__PersonI__6FE99F9F, string Name) {
                AddressRow rowAddressRow = ((AddressRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        null,
                        null,
                        Name};
                if ((parentPersonRowByFK__Address__PersonI__6FE99F9F != null)) {
                    columnValuesArray[1] = parentPersonRowByFK__Address__PersonI__6FE99F9F[0];
                }
        ...
        public partial class AddressRow : global::System.Data.DataRow {
            ...
            public PersonRow PersonRow {
                get {
                    return ((PersonRow)(this.GetParentRow(this.Table.ParentRelations["FK__Address__PersonI__6FE99F9F"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK__Address__PersonI__6FE99F9F"]);
                }
            }
            ...
            public bool IsPersonIdNull() {
                return this.IsNull(this.tableAddress.PersonIdColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetPersonIdNull() {
                this[this.tableAddress.PersonIdColumn] = global::System.Convert.DBNull;
            }
        }
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public AddressRow[] GetAddressRows() {
                if ((this.Table.ChildRelations["FK__Address__PersonI__6FE99F9F"] == null)) {
                    return new AddressRow[0];
                }
                else {
                    return ((AddressRow[])(base.GetChildRows(this.Table.ChildRelations["FK__Address__PersonI__6FE99F9F"])));
                }
            }
        }
...
namespace App_ADO_Net._005_DataSetStrictlyType.DataSet1TableAdapters {
    ...
    public partial class AddressTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Address] WHERE (([Id] = @Original_Id) AND ((@IsNull_PersonId =" +
                " 1 AND [PersonId] IS NULL) OR ([PersonId] = @Original_PersonId)) AND ([Name] = @" +
                "Original_Name))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Address] ([PersonId], [Name]) VALUES (@PersonId, @Name);\r\nSELE" +
                "CT Id, PersonId, Name FROM Address WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Address] SET [PersonId] = @PersonId, [Name] = @Name WHERE (([Id] = @Original_Id) AND ((@IsNull_PersonId = 1 AND [PersonId] IS NULL) OR ([PersonId] = @Original_PersonId)) AND ([Name] = @Original_Name));
SELECT Id, PersonId, Name FROM Address WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::App_ADO_Net.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, PersonId, Name FROM dbo.Address";
