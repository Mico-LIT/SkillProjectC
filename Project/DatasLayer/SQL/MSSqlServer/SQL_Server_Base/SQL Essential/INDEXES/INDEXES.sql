...
word VARCHAR (25)
  ...
  INSERT INTO BTree (numbers,word)
    VALUES 
(1,'one'),
(2,'two'),
(3,'three'),
...
(9,'nine');
  ...
  INSERT  INTO BTree (numbers,word)
    ...
    SELECT * FROM BTree b WHERE b.numbers IN (5,6)
      ------------------------------------------------------
...
SELECT * FROM BTree b WHERE b.word = 'one'


SELECT * FROM sys.indexes WHERE object_id = 
  (SELECT object_id FROM sys.tables t WHERE t.name= 'BTree') 
...
SELECT * FROM sys.indexes i
  ...
  WHERE object_id = (
  SELECT object_id  FROM sys.tables t WHERE t.name= 'Customers'
  )
...
WITH 
(
IGNORE_DUP_KEY = off -- включаем игнорирование различия между строчными и заглавными
);
GO

INSERT INTO Customers -- Скушает
( CustumerNo, CustumerName, Address1, Address2, City, State, Zip, Contact, Phone, FedIDNo, DateInSystem)
VALUES
(1,'Alex', 'NewSTR', 'NewSTR2', 'City', 'NS', 'NewZip', 'dfgjs@mail.ru', '(093)1231212', 'qweq', GETDATE()),
...
INSERT INTO Customers -- будет ошибка
( CustumerNo, CustumerName, Address1, Address2, City, State, Zip, Contact, Phone, FedIDNo, DateInSystem)
VALUES
(1,'Alex', 'NewSTR', 'NewSTR2', 'City', 'NS', 'NewZip', 'dfgjs@mail.ru', '(093)1231212', 'qweq', GETDATE()),
(2,'alex', 'NewSTR2', 'NewSTR22', 'City2', 'SN', 'NewZip2', 'dfg2@mail.ru', '(093)2221212', 'qwq2', GETDATE()); -- Не будет ошибки
